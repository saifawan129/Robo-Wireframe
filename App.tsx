            ...
            <Scroll html>
              <div className="w-screen pointer-events-none z-20 relative">
                ...
                <section className="h-screen w-full flex flex-col items-center justify-center px-8 md:px-24 pt-40 relative overflow-hidden">
                  {/* Background Text Layer - Increased contrast to text-black/10 */}
                  <div className="absolute left-10 top-[25%] max-w-sm pointer-events-none">
                    <h2 className="text-[12vw] font-black text-black/10 leading-none select-none tracking-tighter uppercase italic">Proto</h2>
                  </div>
                ...
                <section className="h-screen w-full flex items-center justify-end px-8 md:px-24 relative">
                  ...
                  <div className="absolute right-10 top-[25%] max-w-sm text-right pointer-events-none">
                    <h2 className="text-[12vw] font-black text-black/10 leading-none select-none tracking-tighter uppercase italic">Systems</h2>
                  </div>
                ...
                <section className="h-screen w-full flex items-center justify-start px-8 md:px-24 relative">
                  {/* Background Text Layer - Increased contrast to text-black/10 */}
                  <div className="absolute left-10 top-[25%] max-w-sm pointer-events-none">
                    <h2 className="text-[12vw] font-black text-black/10 leading-none select-none tracking-tighter uppercase italic">Motion</h2>
                  </div>
                ...
                <section className="h-screen w-full flex items-center justify-end px-8 md:px-24 relative">
                  {/* Background Text Layer - Increased contrast to text-black/10 */}
                  <div className="absolute right-10 top-[25%] max-w-sm text-right pointer-events-none">
                    <h2 className="text-[12vw] font-black text-black/10 leading-none select-none tracking-tighter uppercase italic">Virtual</h2>
                  </div>
                  <div className="z-30 max-w-md text-right pointer-events-auto">
                    <motion.div
                      initial={{ opacity: 0, y: 30 }}
                ...
                <section className="h-screen w-full flex flex-col items-center justify-center p-12 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <h2 className="text-[15vw] font-black text-black/10 select-none tracking-[0.1em] uppercase italic">Archive</h2>
                  </div>
